...
namespace Bookify.Domain.Booking
{
    public sealed class Booking : Entity
    {
        ...
        private Booking(Guid id, Guid apartmentId, Guid userId, DateRange duration, Money priceForPeriod, Money cleaningFee, Money amentitiesUpCharge, Money totalPrice, BookingStatus status, DateTime createdOnUtc) : base(id)
        {
            ...
            AmentitiesUpCharge = amentitiesUpCharge;
